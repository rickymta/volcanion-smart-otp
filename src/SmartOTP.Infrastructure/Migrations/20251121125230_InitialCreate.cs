        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedSecret = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OtpAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OtpAccounts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpAccounts_UserId_Issuer_AccountName",
                table: "OtpAccounts",
                columns: new[] { "UserId", "Issuer", "AccountName" });
